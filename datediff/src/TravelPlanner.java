...
public class TravelPlanner {
    ...
    // Declare a DateTimeFormatter for the standard date format "dd/MM/yyyy"
    // "private" -> only this class can see it or use it
    // "static" -> only one shared copy for the entire class (not per object)
    // "final" -> its value cannot be reassigned after initialization
    ...
    public static long calculateTripDuration(LocalDate departureDate, LocalDate returnDate) {
        // Calculate and return the number of days between departure and return dates
    ...
    public static boolean validateTravelDates(LocalDate departureDate, LocalDate returnDate) {
        ...
        // trip should not last longer than 90 days
                    ...
                    case "4":
                        ...
                        if (validateTravelDates(departureDate, returnDate)) {
                            ...
                            if (overlaps) {
                                ...
                                System.out.println("Your trip does not overlap with this holiday.");
                            }
                        }
                        break;
